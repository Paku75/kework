    ...
    <div class="comptabiliteContainer">
      <h3><?= $tableName ?></h3>
      <p><?= $description ?></p><br>
      <a href="#" id="btn_add4" class="btn btn-primary btn-lg" role="button" data-toggle="modal" data-target="">Ajouter une ligne</a>
      <br><br><br>
      <br><br><br><br>
    ...
    <thead>
      <tr>
        <th colspan="3">INFORMATION GENERALE4</th>
    ...
    <?php foreach ($eps as $ep) { ?>
      <tr>
        ...
        <?php include ('Modals/testtable4.php') ?>
      </tr>
    <?php } ?>
    </tbody>
  </table>
