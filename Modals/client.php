      ...
      <div class="modal-body" style="padding:40px 50px;">
                    <form method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="nom" class="form-control" id="login" placeholder="Entreprise" value="<?= $client['client_nom'] ?>">
                      </div>
                      <div class="form-group">
                        <input type="text" name="prenom" class="form-control" id="login" placeholder="Entreprise" value="<?= $client['client_prenom'] ?>">
                      </div>
                      <div class="form-group">
                        <input type="text" name="tel" class="form-control" id="login" placeholder="Entreprise" value="<?= $client['client_tel'] ?>">
                      </div>
                      <div class="form-group">
                        <input type="text" name="email" class="form-control" id="login" placeholder="Entreprise" value="<?= $client['client_email'] ?>">
                      </div>
                      
                      <h5>-- HISTORIQUE --</h5>
                      <div class="form-group">
                        <input type="date" name="date" class="form-control" id="login" placeholder="Entreprise" value="<?= $client['client_date'] ?>">
                      </div>
                      <div class="form-group">
                        <input type="text" name="historique" class="form-control" id="login" placeholder="Entreprise" value="<?= $client['client_historique'] ?>">
                      </div>
