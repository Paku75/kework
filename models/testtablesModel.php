<?php
    ...
    function getContent($tableName)
    {
        ...
        {
    		$description = "Ceci est table 3.";
            showTable3($tableName, $description);
        }
    	else if ($tableName == "Table 4")
        {
    		$description = "Ceci est table 4.";
            showTable4($tableName, $description);
        }
	...
	{
		include __DIR__ ."/../views/epTableView.php";
	}
    
    function showTable2($tableName, $description)
    {
        include __DIR__ ."/../views/epTable2View.php";
    }
    
    function showTable3($tableName, $description)
    {
        include __DIR__ ."/../views/epTable3View.php";
    }
    
    function showTable4($tableName, $description)
    {
        include __DIR__ ."/../views/epTable4View.php";
    }
